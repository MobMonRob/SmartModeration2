...
public class CantDeleteCurrentSpeakerException extends SmartModerationException {
    @Override
    public String getMessage(Context context) {
        return context.getString(R.string.CantDeleteCurrentSpeakerException_Message);
    }
