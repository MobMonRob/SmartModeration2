...
public class ConnectionService {
	...
	public boolean addContactToGroup(PrivateGroup group, Contact contact) {
	...
	private void connectToContact(Contact contact) {
		...
		if (bluetoothPlugin == null) throw new AssertionError("Bluetooth Plugin should have been found to connect");
